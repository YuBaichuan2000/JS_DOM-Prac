 ...
 */
function clearAll() {
  let additionals = document.querySelectorAll('.additionals');
  for (let i=0; i<additionals.length; i++){
    additionals[i].remove();
  }
}
...
function showMeme() {
  ...
  clearAll();
  let parent = document.querySelector(".outputs");
  let img = document.createElement('img');
  let sections = document.querySelectorAll('h3');
  img.setAttribute('src', randomMemeUrl);
  img.setAttribute('alt', 'a meme');
  img.setAttribute('class', 'additionals')
  parent.insertBefore(img, sections[1]);
}
...
function showJoke() {
  ...
  let sections = document.querySelectorAll('h3');
  joke.innerText = randomJokeText;
  joke.setAttribute('class', 'additionals')
  parent.insertBefore(joke, sections[2]);
}
...
function showQuote() {
  ...
  quote.setAttribute('class', 'additionals');
  author.setAttribute('class', 'additionals');
  parent.insertBefore(quote, sections[3]);
  parent.insertBefore(author, sections[3]);
}
...
function showRiddle() {
  ...
  question.innerText = randomRiddle.question;
  answer.innerText = randomRiddle.answer;
  question.setAttribute('class', 'additionals');
  answer.setAttribute('class', 'additionals riddle-answer');
  answer.style.display = 'none';
  parent.insertBefore(question, sections[3].nextSibling);
  parent.insertBefore(answer, sections[3].nextSibling.nextSibling);
}
...
function revealAnswers() {
  ...
  if (answer.style.display === 'none'){
    ...
    window.alert('answer is already there');
  }
}
